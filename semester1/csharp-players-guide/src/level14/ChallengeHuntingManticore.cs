namespace CSharpPlayersGuide.level14
{
    internal class ChallengeHuntingManticore : IExercise
    {
        ...
        {
            ManticoreLocation = AskForNumberInRange("Player 1, how far away from the city " +
                "do you want to station the Manticore?", MIN_RANGE, MAX_RANGE);
        }
        public void Run()
        {
            var currentRound = 1;
