...
Computer computer = new Notebook("Acme", "Intel", 32, 2560, 4.7);
...
Computer computer1 = new Notebook("INTEL", 32, 256);
...
public class Notebook : Computer
{
    ...
    public override double ComputePower() { return RamSize * ProcessorSpeed; }
    public override int GetRamSize() { return RamSize; }
    public override double GetProcessorSpeed() { return ProcessorSpeed; }
    public override int GetDiskSize() { return DiskSize; }
    ...
    public override double CostBenefit(double constBenefit) => constBenefit * 2;
}
public abstract class Computer
{
    ...
    public abstract int GetDiskSize();
    ...
    public abstract double CostBenefit(double costBenefit);
}